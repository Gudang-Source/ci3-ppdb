    ...
    <div class="container border text-black">
        ...
        <form action="<?php echo site_url('pendaftaran/kirim'); ?>" method="post" id="formulir-daftar">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4 col-md-4">
                    <select name="gender" class="form-control" required data-msg="Mohon untuk mengisi kolom ini">
                ...
                <div class="col-sm-4 col-md-4">
                    <select name="agama1" class="form-control" required data-msg="Mohon untuk mengisi kolom ini">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-10">
                    <input type="text" class="form-control" name="alamat1" placeholder="Alamat tempat tinggal saat ini"
                        required data-msg="Mohon untuk mengisi kolom ini">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-10">
                    <input type="text" class="form-control" name="alamat2" placeholder="Alamat tempat tinggal saat ini">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10 col-md-10">
                    <input type="text" class="form-control" name="alamat3" placeholder="Alamat tempat tinggal saat ini">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4 col-md-4">
                    <input type="number" class="form-control" name="dari_kelas" id="from-class" placeholder="Dari kelas">
                </div>
            </div>
            <div class="row">
                <div class="col-12">
            ...
            <label class="col">Memiliki kartu keluarga miskin yang masih berlaku ?</label>
                <div class="mr-3">
                    <input type="radio" class="form-check-input" id="punya-kkm1" name="kk_miskin" value="Punya">
                    <label class="form-check-label" for="punya-kkm1">Punya</label>
                </div>
                <div class="ml-3">
                    <input type="radio" class="form-check-input" id="punya-kkm2" name="kk_miskin" value="Tidak Punya">
                    <label class="form-check-label" for="punya-kkm2">Tidak Punya</label>
                </div>
            </div>
